...
<head>
  ...
  <title>MetoHub — Launch your grocery store</title>
...
<body>
  ...
  <header>
    <nav>
      <div class="logo"><span class="logo-mark"></span>MetoHub</div>
      <div class="nav-links">
    ...
    <div class="wrap">
      <div class="hero-grid">
        <div>
          ...
          <p class="lede">MetoHub turns your inventory into a real online grocery store — orders, delivery zones,
    ...
    <div class="wrap">
      ...
      <div class="steps">
        <div class="step">
          ...
          <p>Import a spreadsheet or add items one by one — name, price, unit, photo. MetoHub organizes it into
    ...
    <div class="wrap">
      <div class="faq-layout">
        <div class="faq-left">
          ...
          <p>Still not sure? Reach out to the MetoHub team — we typically respond within a few hours.</p>
